...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'game_of_life.data';
      var REMOTE_PACKAGE_BASE = 'game_of_life.data';
  ...
  Module['FS_createPath']("/", "data", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_game_of_life.data');

      };
      Module['addRunDependency']('datafile_game_of_life.data');
   ...
   loadPackage({"files": [{"filename": "/data/dummy", "start": 0, "end": 0, "audio": 0}], "remote_package_size": 0, "package_uuid": "c6a2d777-24b9-4385-b765-063d9854e921"});
...
var wasmBinaryFile = 'game_of_life.wasm';
...
var ASM_CONSTS = {
  51816: function() {var canvas = document.getElementById('canvas'); canvas.style.width = (canvas.width / window.devicePixelRatio) + 'px'; canvas.style.height = (canvas.height / window.devicePixelRatio) + 'px';},
 52006: function() {setTimeout(function() { var canvas = document.getElementById('canvas'); canvas.style.width = (canvas.width / window.devicePixelRatio) + 'px'; canvas.style.height = (canvas.height / window.devicePixelRatio) + 'px'; }, 0);}
};
